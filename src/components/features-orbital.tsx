...
const FEATURES: Feature[] = [
  {
    id: 1,
    title: "نفهم مجالك قبل أن نلمس الكود",
    subtitle: "شركاء في الرؤية قبل التنفيذ",
    content:
      "لا نبدأ بالتقنية، نبدأ بدراسة قطاعك ومنافسيك وعملائك. هذا ما جعل عملاءنا يقولون: فهمتم مجالنا كأنكم شركاء فيه. لأن الحل الذي يُبنى بفهم عميق، يصل إلى الهدف من أول مرة.",
    icon: Handshake,
    relatedIds: [3, 4],
    status: "core",
    energy: 90,
  ...
  {
    id: 2,
    title: "سرعة تنفيذ تفوق التوقعات",
    subtitle: "نصل إلى السوق قبل منافسيك",
    content:
      "العديد من عملائنا اشاد بسرعة التنفيذ و اجراء التعديلات. نملك منهجيات تطوير رشيقة وخبرة متراكمة تمكننا من تسليم مشروعك في وقت قياسي، دون المساس بالجودة أو الأمان. السرعة هنا ميزة تنافسية لك وليست اختصاراً.",
    icon: Zap,
    relatedIds: [3, 5],
    status: "core",
    energy: 80,
  ...
  {
    id: 3,
    title: "اتفاق واضح ومفصل قبل البداية",
    subtitle: "لا غموض، لا تكاليف مخفية",
    content:
      "قبل أن نكتب أول سطر كود، تتفق معنا على كل شيء: المتطلبات، المميزات، المدة الزمنية، والمنتج النهائي الذي سيتم تسليمه. كل شيء موثق وواضح. هذه الشفافية تزيل أكبر مخاوفك وتمنحك راحة البال منذ اليوم الأول.",
    icon: FileCheck,
    relatedIds: [1, 5],
    status: "core",
    energy: 90,
  ...
  {
    id: 4,
    title: "ابتكار حلول ذكية منخفضة التكلفة",
    subtitle: "نوفر عليك الوقت والمال",
    content:
      "هذه هي قوتنا الخفية. نبتكر طرقاً تقنية منخفضة التكاليف وسريعة التنفيذ لعمليات معقدة كانت تتطلب عادةً ميزانيات ضخمة وأشهراً من العمل. نجد لك الطريق الأقصر والأذكى لتحقيق هدفك دون أن تدفع ثمن التعقيد.",
    icon: Lightbulb,
    relatedIds: [2, 6],
    status: "advanced",
    energy: 90,
  ...
  {
    id: 5,
    title: "نسلم ما وعدنا به في الوقت المحدد",
    subtitle: "الالتزام بالموعد والمخرجات",
    content:
      "الاتفاق الذي نوقع عليه ليس مجرد ورق. نلتزم بالمدة الزمنية والمنتج النهائي كما تم تحديدهما بالضبط. لا تأخير، لا تغيير في النطاق دون موافقتك. احترام وقتك هو جزء من احترامنا لشراكتنا.",
    icon: Clock,
    relatedIds: [3, 8],
    status: "core",
    energy: 80,
  ...
  {
    id: 6,
    title: "دعم فني دائم ومجاني بعد الإطلاق",
    subtitle: "نبقى معك دائماً",
    content:
      "لا تنتهي علاقتنا بتسليم المشروع. نقدم لك دعماً فنياً مجانياً ودائماً بعد الإطلاق، يشمل حل جميع المشاكل التقنية التي قد تظهر لاحقاً في المنتج. نحن معك في كل خطوة، لأن نجاحك المستمر هو نجاحنا.",
    icon: Headphones,
    relatedIds: [5, 7],
    status: "premium",
    energy: 80,
  ...
  },
  {
    ...
    subtitle: "بناء، استشارة، أو شراكة",
    content:
      "لا تقيدك طريقة واحدة. نوفر خيارات مرنة: تنفيذ مشروعك مقابل أجر، جلسات ودراسات استشارية متخصصة، أو ندخل معك كشريك تقني تنفيذي إن آمنّا بفكرتك وشاركناك رحلة النمو.",
    icon: GitBranch,
    relatedIds: [1, 8],
    status: "advanced",
    energy: 7,
  ...
  {
    id: 8,
    title: "أمان وموثوقية من اليوم الأول",
    subtitle: "منتجك محمي بالكامل",
    content:
      "لا ننتظر حصول مشكلة أمنية لنعالجها. نبني منتجك وفق أفضل ممارسات الأمن السيبراني، ونضمن حماية بياناتك وبيانات عملائك. الموثوقية والأمان جزء لا يتجزأ من بنية الحل الذي نبنيه، وليس ميزة إضافية.",
    icon: ShieldCheck,
    relatedIds: [5, 6],
    status: "core",
    energy: 80,
...
export function FeaturesOrbital() {
  ...
  const getTargetAngleForIndex = useCallback(
    ...
    autoPlayRef.current = setInterval(() => {
      setActiveIndex((prev) => {
        ...
        setTargetAngle((currentAngle) =>
          getTargetAngleForIndex(next, currentAngle),
        );
        return next;
      });
    }, 8000);
  ...
  const goToFeature = useCallback(
    (index: number) => {
      ...
      setTargetAngle((currentAngle) =>
        getTargetAngleForIndex(index, currentAngle),
      );
              ...
              <div className="relative w-full h-full flex items-center justify-center">
                ...
                >
                  <div className="relative">
                    ...
                    <div className="relative w-16 h-16 md:w-24 md:h-24 rounded-full bg-gradient-to-br from-purple-600 via-purple-500 to-blue-600 flex items-center justify-center shadow-2xl shadow-purple-500/30"></div>
                  </div>
                      ...
                      <div className="pt-5 border-t border-gray-800/50">
                        ...
                        <div className="flex flex-wrap gap-2">
                          {activeFeature.relatedIds.map((relatedId) => {
                            ...
                            const relatedIndex = FEATURES.findIndex(
                              (f) => f.id === relatedId,
                            );
